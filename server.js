...
const bcrypt = require('bcrypt'); // secure passwords // for unique IDs
...
app.post('/api/register', (req, res) => {
  ...
  users[cleanUser] = {
    password: bcrypt.hashSync(cleanPass, 10), // hash password
...
app.post('/api/login', (req, res) => {
  ...
  if (!user || !bcrypt.compareSync(cleanPass, user.password)) { // compare hashed password
...
app.post('/api/reset-password', (req, res) => {
  ...
  users[cleanUser].password = bcrypt.hashSync(cleanPass, 10); // hash new password
  saveUsers();
